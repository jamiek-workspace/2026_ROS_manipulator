  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x01, 0xeb, 0xff, 0xfc, 0x88, 0x7f, 0xd3, 0x90,
      0x8e, 0xef, 0x6f, 0x80, 0x85, 0x02, 0xb4, 0x02,
      0x4d, 0x45, 0x15, 0xc1, 0x6e, 0xf2, 0x49, 0xe9,
      0x8b, 0x7a, 0xce, 0x19, 0x0f, 0x18, 0xde, 0x68,
    }};
  return &hash;
}
...
static char user_interface__msg__UserInt__FIELD_NAME__header[] = "header";
...
static rosidl_runtime_c__type_description__Field user_interface__msg__UserInt__FIELDS[] = {
  {
    {user_interface__msg__UserInt__FIELD_NAME__header, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription user_interface__msg__UserInt__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {user_interface__msg__UserInt__FIELDS, 4, 4},
    },
    {user_interface__msg__UserInt__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
